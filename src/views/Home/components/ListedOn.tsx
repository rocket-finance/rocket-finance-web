...
import { Card, CardBody, Heading, Image, Text } from 'rocket-finance-uikit'
  ...
  return (
    <StyledListedOn>
      <CardBody>
        ...
        {/* <LinkListed>
          <a
            href="https://dex.apeswap.finance/#/swap?outputCurrency=0xcc0743bc0b2122a43881aac5597650ce82d9caaa"
            target="_blank"
            rel="noreferrer"
          >
            <Image
