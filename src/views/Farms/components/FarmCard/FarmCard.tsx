...
import { Flex, Text, Skeleton, Link } from 'rocket-finance-uikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'ROCKET'
  ...
  return (
    <FCard>
      ...
      {farm.tokenSymbol === 'ROCKET' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
        ...
        <div>
          ...
          <Text style={{ textAlign: 'center' }}>
            <Link
              ...
              fontSize="14px"
              mt="10px"
              to="https://tapswapmoneydex.medium.com/partnership-with-apeswap-finance-c1dd2dd44eee"
              target="blank"
