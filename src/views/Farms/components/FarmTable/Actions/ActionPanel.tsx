...
import { LinkExternal, Text, Link } from 'rocket-finance-uikit'
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          Stake:
          <StyledLinkExternal to={`${getUrl}`}>{lpLabel}</StyledLinkExternal>
        </StakeContainer>
        <StyledLink to={bsc} external>
          {TranslateString(999, 'BscScan')}
        </StyledLink>
        <StyledLink to={info} external>
