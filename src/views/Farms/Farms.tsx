...
import { Image, Heading, RowType, Toggle, Text, HelpIcon, Link } from 'rocket-finance-uikit'
...
const data = {
  ...
  rows: [
    ...
    //   content: `These farms use liquidities from the ApeSwap DEX. To provide LP to these farms, you need to use ApeSwap DEX interface by following <a href="https://swape.tapswap.money/#/swap?inputCurrency=0xe9e7cea3dedca5984780bafc599bd69add087d56&outputCurrency=0xcc0743bc0b2122a43881aac5597650ce82d9caaa" target="_blank" style="color: orange;font-weight: bold">this link</a>. Read more about the TapSwap & ApeSwap partnership in this <a href="https://tapswapmoneydex.medium.com/partnership-with-apeswap-finance-c1dd2dd44eee" target="_blank" style="color: orange;font-weight: bold">blog post</a>.`,
    // },
    {
      title: 'What means PCS LP ribbon on farms ?',
      content: `These farms use liquidities from the <strong>P</strong>an<strong>C</strong>ake<strong>S</strong>wap DEX. TapSwap keep these farms available to be fair with users who paid deposit fees to enter into. To provide LP to these farms, you need to use PanCakeSwap DEX interface by following <a href="https://swap.tapswap.money/#/swap?inputCurrency=0xe9e7cea3dedca5984780bafc599bd69add087d56&outputCurrency=0xcc0743bc0b2122a43881aac5597650ce82d9caaa" target="_blank" style="color: orange;font-weight: bold">this link</a>. All futures farms created on TapSwap will use APE LP. Read more about the TapSwap & ApeSwap partnership in this <a href="https://tapswapmoneydex.medium.com/partnership-with-apeswap-finance-c1dd2dd44eee" target="_blank" style="color: orange;font-weight: bold">blog post</a>.`,
    },
    {
    ...
    <>
      <Header>
        ...
        <Heading size="lg" color="text">
          {TranslateString(10000, 'Deposit Fee will be used to buyback ROCKET')}
        </Heading>
        {/* <Text>
          <AddressLink
