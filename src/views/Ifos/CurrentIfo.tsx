...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from 'rocket-finance-uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal to="https://swap.tapswap.money/#/swap" mr="16px">
              {TranslateString(1060, 'Buy ROCKETS')}
            </LinkExternal>
            <LinkExternal to="https://swap.tapswap.money/#/add/ETH/0xcc0743bc0b2122a43881aac5597650ce82d9caaa">
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with ROCKET FINANCE, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
