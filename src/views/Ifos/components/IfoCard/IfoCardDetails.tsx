...
import { Text, LinkExternal, Link, Box, CardFooter, Button, ChevronDownIcon, ChevronUpIcon } from 'rocket-finance-uikit'
    ...
    <CardFooter>
      ...
      {isOpen && (
        <>
          ...
          <Box mb="24px">
            <Item>
              ...
              <Text>
                {launchDate},
                <Link
                  to="https://www.timeanddate.com/worldclock/singapore/singapore"
                  target="blank"
          ...
          <LinkExternal to={projectSiteUrl} style={{ margin: 'auto' }}>
