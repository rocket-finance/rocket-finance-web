...
const pools: PoolConfig[] = [
  ...
  //   stakingTokenName: QuoteToken.ROCKETS,
  //   stakingTokenAddress: '0xcc0743bc0b2122a43881aac5597650ce82d9caaa',
  ...
  //   isLp: false,
  //   bushVersion: 1,
  //   getUrl: '/#/swap?outputCurrency=0xcc0743bc0b2122a43881aac5597650ce82d9caaa',
  // },
  // {
  //   sousId: 99, // V1
  //   tokenName: 'WBNB',
