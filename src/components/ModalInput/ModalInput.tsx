...
import { Text, Button, Input, InputProps, Flex, Link } from 'rocket-finance-uikit'
    ...
    <div style={{ position: 'relative' }}>
      ...
      {isBalanceZero && (
        <StyledErrorMessage fontSize="14px" color="failure">
          No tokens to stake:{' '}
          <Link to={addLiquidityUrl} fontSize="14px" bold={false} href={addLiquidityUrl} external color="failure">
